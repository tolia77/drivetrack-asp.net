...
/// <summary>
/// NFR-27's "validated rather than passed through unchecked", over the delivery list.
/// <para>
...
/// </para>
/// </summary>
public sealed class ListDeliveriesQueryValidator : AbstractValidator<ListDeliveriesQuery>
{
    ...
    public ListDeliveriesQueryValidator()
    {
