...
/// <c>.env.example</c> and <c>compose.yaml</c>. Nothing here has a committed default that would
/// still work: a signing key with a fallback is a signing key everyone knows.
/// </para>
/// </summary>
