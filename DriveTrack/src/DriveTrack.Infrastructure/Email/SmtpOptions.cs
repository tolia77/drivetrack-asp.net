...
/// <c>.env.example</c> and <c>compose.yaml</c>. The property names match those spellings exactly,
/// because a binder that silently leaves a property at its default is the failure mode this section
